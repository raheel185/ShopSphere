...
const SearchBar = () => {
    ...
    useEffect(()=>{
        ...
        if(cur_path.includes('collection')){
            setVisible(true) 
        }
        else{
            setVisible(false)
  ...
  return showSearch && visible ? (
    <div className='border-t border-b bg-gray-50 text-center'>
        <div className='inline-flex items-center justify-center border border-gray-400 px-5 py-2 my-5 mx-3 rounded-full w-3/4 sm:w-1/2'>
            <input value={search} onChange={(e)=>setSearch(e.target.value)} type="text" placeholder='Search' className='w-full outline-none bg-inherit flex-1' />
